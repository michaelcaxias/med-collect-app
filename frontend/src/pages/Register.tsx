      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-indigo-600 to-blue-500 p-12 text-white justify-center items-center">
        <div className="max-w-xl">
          ...
          <p className="text-xl text-indigo-100">
            Junte-se a nós e comece a gerenciar suas coletas médicas de forma simples e eficiente
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-xl shadow-lg p-8 space-y-6">
            <div className="text-center md:text-left">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-1">Criar conta</h3>
